...
bottomMsg = ""
msg = "Esperando Conexão"
currentPlayer = 0
xy = (-1, -1)
allow = 0 #movimento do mouse
...
def buildScreen(bottomMsg, string, playerColor = subtitleColor):
    ...
    screen.blit(title, (110, 0)) # desenha o título
...
#centraliza a mensagem do jogador
...
def validate_input(x, y):
    if x > 3 or y > 3:
        ...
        print("\nJá preenchido, Tente novamente...\n")
        return False
    return True
    
#aceita movimentos do mouse
def handleMouseEvent(pos):
    ...
    if(x < 150 or x > 450 or y < 150 or y > 450):
        ...
        # Quando x aumenta, a coluna muda
        col = int(x/100 - 1.5)
        # Quando y aumenta, a linha muda
        row = int(y/100 - 1.5)
