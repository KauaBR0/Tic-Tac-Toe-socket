...
def get_input(currentPlayer):
    if currentPlayer == playerOne:
        player = "Vez do jogador um"
        conn = playerConn[0]
    else:
        player = "Vez do jogador dois"
        conn = playerConn[1]
    print(player)
...
def start_game():
    ...
    #Verifica vencedor e empate
    if result == 1:
        lastmsg = "Jogador um venceu!"
    elif result == 2:
        lastmsg = "Jogador dois venceu!"
    else:
        lastmsg = "EMPATE"
